...
def _is_calibration_episode(episode: dict[str, Any]) -> bool:
    return str(episode.get("target_kind") or "") in {"planner_runtime_prompt", "skill_editor_prompt", "memory_editor_prompt", "evaluator"} or str(episode.get("episode_kind") or "") in {
        "prompt_candidate",
        "prompt_promotion",
        "calibration_update",
    }
