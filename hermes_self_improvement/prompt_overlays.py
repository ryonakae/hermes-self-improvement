...
ALLOWED_PROMPT_ROLES = {"target_resolver", "improvement_planner", "skill_agent", "memory_agent", "evaluator"}
DEFAULT_PROMPT_SEED_ROLES = ("target_resolver", "improvement_planner", "skill_agent", "memory_agent", "evaluator")
