...
2. **One Planner, one Knowledge Editor.** The planner judges across skills, `USER.md`, `MEMORY.md`, none, and memory-to-skill. The editor improves across skills and memory. Tool-specific adapters may exist internally, but user-facing reports/plans should not describe separate skill/memory editor roles.
