...
- **Outcome / credit assignment:** around 7.7合目.
  - Milestone 5 phase 5.1 surfaces immediate/short/medium/long scoring windows in the compact credit-assignment summary (`outcomes.credit_windows`) and CLI `Outcomes:` section (`scored window coverage`), so daily-facing output distinguishes early vs late credit rather than only "tracked".
