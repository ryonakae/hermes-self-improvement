...
- `hermes_self_improvement/analysis.py`: event aggregation、finding 抽出、proposal 生成。explicit `memory_compression_candidate` / `skill_lifecycle_candidate` は approval-required proposal に変換するが、auto-apply 許可にはしない。
